            ...
            children: [
                {text: 'Overview', link: '/manual/jobs/job-plugins/index.md'},
                {
                    ...
                    children: [
                        ...
                        {text: 'Kubernetes Create Object (Beta)', link: '/manual/jobs/job-plugins/node-steps/kubernetes-create-object', icon: '/assets/img/kubernetes-icon.png'},
                        {text: 'Kubernetes Delete Object (Beta)', link: '/manual/jobs/job-plugins/node-steps/kubernetes-delete-object', icon: '/assets/img/kubernetes-icon.png'},
                        {text: 'Kubernetes Describe Object (Beta)', link: '/manual/jobs/job-plugins/node-steps/kubernetes-describe-object', icon: '/assets/img/kubernetes-icon.png'},
                        {text: 'Kubernetes List Objects (Beta)', link: '/manual/jobs/job-plugins/node-steps/kubernetes-list-objects', icon: '/assets/img/kubernetes-icon.png'},
                        {text: 'Kubernetes Object Logs (Beta)', link: '/manual/jobs/job-plugins/node-steps/kubernetes-object-logs', icon: '/assets/img/kubernetes-icon.png'},
                        {text: 'Kubernetes Run Command (Beta)', link: '/manual/jobs/job-plugins/node-steps/kubernetes-run-command', icon: '/assets/img/kubernetes-icon.png'},
                        {text: 'Kubernetes Run Script (Beta)', link: '/manual/jobs/job-plugins/node-steps/kubernetes-run-script', icon: '/assets/img/kubernetes-icon.png'},
                        {text: 'Kubernetes Update Object (Beta)', link: '/manual/jobs/job-plugins/node-steps/kubernetes-update-object', icon: '/assets/img/kubernetes-icon.png'},
